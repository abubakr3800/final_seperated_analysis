"""
Simple API Server for PDF Report Extraction
==========================================

A Flask-based API that accepts PDF file uploads and returns extracted JSON data.
This is a separate interface that doesn't interfere with the existing command-line tools.
"""
...
# Using enhanced_parser for better uniformity extraction
...
def home():
    ...
    return jsonify({
        "message": "PDF Report Extraction API",
        "version": "1.0",
        "endpoints": {
...
def extract_pdf():
    ...
    try:
        ...
        # Extract data from PDF using enhanced parser
...
if __name__ == '__main__':
    print("Starting PDF Report Extraction API Server...")
    print("=" * 50)
    print("API Endpoints:")
